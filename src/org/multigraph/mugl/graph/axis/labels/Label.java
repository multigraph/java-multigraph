...
public class Label extends MuglBean {
    ...
    public static Label parse( Element node, Element defaultsNode, org.multigraph.mugl.graph.axis.Labels parent ) throws Exception {
