 ...
 *       &lt;attribute name="min" type="{http://www.w3.org/2001/XMLSchema}string" default="auto" />
 *       &lt;attribute name="max" type="{http://www.w3.org/2001/XMLSchema}string" default="auto" />
...
public class Axis {
    ...
    public DataType getType() {
        if (type == null) {
            return new Adapter2().unmarshal("number");
        } else {
            return type;
        }
    }
    ...
    public RGBColor getColor() {
        if (color == null) {
            return new Adapter1().unmarshal("0x000000");
        } else {
            return color;
        }
    }
