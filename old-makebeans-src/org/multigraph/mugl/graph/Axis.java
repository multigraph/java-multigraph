...
public class Axis extends MuglBean {
    ...
    private org.multigraph.mugl.graph.axis.Title title;
    private boolean titleIsDefault = false;
    private org.multigraph.mugl.graph.axis.Zoom zoom;
    private boolean zoomIsDefault = false;
    private org.multigraph.mugl.graph.axis.Pan pan;
    private boolean panIsDefault = false;
    private org.multigraph.mugl.graph.axis.Grid grid;
    private boolean gridIsDefault = false;
    private org.multigraph.mugl.graph.axis.Labels labels;
	...
	public org.multigraph.mugl.graph.axis.Title getTitle() {
		return title;
	}
	public void setTitle(org.multigraph.mugl.graph.axis.Title title) {
		this.title = title;
	}
	public void setTitle(org.multigraph.mugl.graph.axis.Title title, boolean isDefault) {
        setTitle(title);
	...
	public org.multigraph.mugl.graph.axis.Zoom getZoom() {
		return zoom;
	}
	public void setZoom(org.multigraph.mugl.graph.axis.Zoom zoom) {
		this.zoom = zoom;
	}
	public void setZoom(org.multigraph.mugl.graph.axis.Zoom zoom, boolean isDefault) {
        setZoom(zoom);
	...
	public org.multigraph.mugl.graph.axis.Pan getPan() {
		return pan;
	}
	public void setPan(org.multigraph.mugl.graph.axis.Pan pan) {
		this.pan = pan;
	}
	public void setPan(org.multigraph.mugl.graph.axis.Pan pan, boolean isDefault) {
        setPan(pan);
        this.panIsDefault = isDefault;
    }
    public boolean havePan() {
        return this.pan != null;
    }
	public org.multigraph.mugl.graph.axis.Grid getGrid() {
		return grid;
	}
	public void setGrid(org.multigraph.mugl.graph.axis.Grid grid) {
		this.grid = grid;
	}
	public void setGrid(org.multigraph.mugl.graph.axis.Grid grid, boolean isDefault) {
        setGrid(grid);
        this.gridIsDefault = isDefault;
    }
    public boolean haveGrid() {
        return this.grid != null;
    }
	public org.multigraph.mugl.graph.axis.Labels getLabels() {
		return labels;
	}
	public void setLabels(org.multigraph.mugl.graph.axis.Labels labels) {
		this.labels = labels;
	}
	public void setLabels(org.multigraph.mugl.graph.axis.Labels labels, boolean isDefault) {
        setLabels(labels);
    ...
    public static Axis parse(Orientation orientation, Element node, Element defaultsNode, org.multigraph.mugl.Graph parent ) throws Exception {
        ...
        setProperty("color", node, defaultsNode,
                    new PropertySetter() { public void set(String value, boolean isDefault) {
                        axis.setColor( new RGBColor(value), isDefault );
                    }});
        ...
        
        {
            ...
            if (element != null) {
                axis.setTitle( org.multigraph.mugl.graph.axis.Title.parse( element, defaultsElement, axis), false );
            } else if (defaultsElement != null) {
            	org.multigraph.mugl.graph.axis.Title title = org.multigraph.mugl.graph.axis.Title.parse( null, defaultsElement, axis);
        ...
        }
        {
            ...
            if (element != null) {
                axis.setZoom( org.multigraph.mugl.graph.axis.Zoom.parse( element, defaultsElement, axis), false );
            } else if (defaultsElement != null) {
            	org.multigraph.mugl.graph.axis.Zoom zoom = org.multigraph.mugl.graph.axis.Zoom.parse( null, defaultsElement, axis);
        ...
        }
        {
            ...
            if (element != null) {
                axis.setPan( org.multigraph.mugl.graph.axis.Pan.parse( element, defaultsElement, axis), false );
            } else if (defaultsElement != null) {
            	org.multigraph.mugl.graph.axis.Pan pan = org.multigraph.mugl.graph.axis.Pan.parse( null, defaultsElement, axis);
        ...
        }
        {
            ...
            if (element != null) {
                axis.setGrid( org.multigraph.mugl.graph.axis.Grid.parse( element, defaultsElement, axis), false );
            } else if (defaultsElement != null) {
            	org.multigraph.mugl.graph.axis.Grid grid = org.multigraph.mugl.graph.axis.Grid.parse( null, defaultsElement, axis);
        ...
        }
        {
            ...
            if (element != null) {
                axis.setLabels( org.multigraph.mugl.graph.axis.Labels.parse( element, defaultsElement, axis), false );
            } else if (defaultsElement != null) {
            	org.multigraph.mugl.graph.axis.Labels labels = org.multigraph.mugl.graph.axis.Labels.parse( null, defaultsElement, axis);
    ...
    public Element build(boolean includeAll) throws Exception {
        ...
        if (haveZoom() && (includeAll || !zoomIsDefault)) { element.addContent( zoom.build(includeAll)  ); }
        if (havePan() && (includeAll || !panIsDefault)) { element.addContent( pan.build(includeAll)  ); }
        if (haveGrid() && (includeAll || !gridIsDefault)) { element.addContent( grid.build(includeAll)  ); }
        if (haveLabels() && (includeAll || !labelsIsDefault)) { element.addContent( labels.build(includeAll)  ); }
        return element;
    }
}
