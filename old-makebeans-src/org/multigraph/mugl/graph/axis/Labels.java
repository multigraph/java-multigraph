...
public class Labels extends MuglBean {
    ...
    private ArrayList<org.multigraph.mugl.graph.axis.labels.Label> labels = new ArrayList<org.multigraph.mugl.graph.axis.labels.Label>();
	...
	public ArrayList<org.multigraph.mugl.graph.axis.labels.Label> getLabels() {
		return labels;
	}
    public static Labels parse( Element node, Element defaultsNode, org.multigraph.mugl.graph.Axis parent ) throws Exception {
        ...
        
        {
            ...
            for (Element element : elements) {
                if (element != null) {
                    labels.getLabels().add( org.multigraph.mugl.graph.axis.labels.Label.parse( element, defaultsElement, labels) );
                } else {
                	org.multigraph.mugl.graph.axis.labels.Label label = org.multigraph.mugl.graph.axis.labels.Label.parse( null, defaultsElement, labels);
    ...
    public Element build(boolean includeAll) throws Exception {
        ...
        for (org.multigraph.mugl.graph.axis.labels.Label label : labels) {
