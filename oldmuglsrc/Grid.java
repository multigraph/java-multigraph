...
public class org.multigraph.mugl.graph.axis.Grid extends MuglBean {
    ...
    public static org.multigraph.mugl.graph.axis.Grid parse( Element node, Element defaultsNode, Axis parent ) throws Exception {
        final org.multigraph.mugl.graph.axis.Grid grid = new org.multigraph.mugl.graph.axis.Grid();
